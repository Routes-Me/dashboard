export const GApiConstants = {
    ...
    createWebToken_REQUEST   : 'CREATE_WEBTOKEN_REQUEST',
    createWebToken_SUCCESS   : 'CREATE_WEBTOKEN_SUCCESS',
    createWebToken_ERROR     : 'CREATE_WEBTOKEN_ERROR',

    getPolicies_REQUEST : 'GETPOLICIES_REQUEST',
