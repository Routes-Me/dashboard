...
class Institutions extends Component {
  ...
  openSubMenuForInstitutionId = (e, institutionId) => {
    ...
    this.setState({
      optionsIndex:
        this.state.optionsIndex === institutionId ? 0 : institutionId,
    });
  };
  ...
  static getDerivedStateFromProps(props, state) {
    if (state.showDetails) {
      if (
        props.ApplicationState === institutionConstants.saveInstitutions_SUCCESS
      ) {
  ...
  componentDidUpdate() {
    if (
      ...
      institutionConstants.saveInstitutions_SUCCESS
    ) {
      this.props.getInstitutionsList(1, config.Pagelimit);
    }
  }
  ...
  showInstitutionsList(institutionsList) {
    console.log(institutionsList?.data);
    return (
      <div>
        <PageHandler
          page={institutionsList.page}
          getList={this.props.getInstitutionsList}
          style="header"
        />
        <div className="table-list padding-lr-80">
                    ...
                    <td className="width20">
                      <div className="edit-popup">
                        <div
                          ...
                          onClick={(e) =>
                            this.openSubMenuForInstitutionId(
                              e,
                        ...
                        >
                          <li>
                            <a
                              onClick={(e) =>
                                this.showDetailScreen(e, institution)
                              }
                            >
                              Edit
                            </a>
          ...
          <div className="row">
            {institutionsList?.data == undefined && (
              <span
...
const connectedInstitutions = connect(
  mapStateToProps,
  actionCreators
)(Institutions);
