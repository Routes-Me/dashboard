...
function Analytics(advertisementList) {
    ...
    const data =  
    [
        {name: 'Routes',            iOS: 18+11+10+4+3+2+4+8,    Android:4+4+14+3+1+2,          web: 8+2+1+2, Windows: 11+2+4+1+3+1+4,       Mac:16+4},
        {name: 'McDonalds',         iOS: 4+3+1+6+2+4+1,         Android: 0+1+3+2+3+2+1+1+1,    web: 2,       Windows: 0+1+1+5+1+1,          Mac:0},
